...
export const LaTeXRenderer: React.FC<{ latex: string; setError: (error: string | null) => void; }> = React.memo(({ latex, setError }) => {
    ...
    return <div id="latex-output" style={{ marginBottom: '10px' }}></div>;
});